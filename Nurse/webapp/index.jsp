...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<meta charset="utf-8">
		<link rel="Shortcut Icon" type="image/ico"
			href="https://di388e0fcqllf.cloudfront.net/images/favicon.png">
...
a.call-action {
	...
	/* add a gradient */
	background: -webkit-gradient(linear, left top, left bottom, from(#FB9649),
		to(#F96C00) );
	background: -moz-linear-gradient(top, #FB9649, #F96C00);
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#FB9649',
		endColorstr='#F96C00' );
}
...
table.t-data1 td,table.t-data1 th {
...
#cb-header #main-nav ul ul a,#cb-header #main-nav li.selected ul a,#cb-header #main-nav li.open ul a
	{
	border: 0;
	color: #333;
	font-weight: normal;
...
<body>
	...
	<div class="cb-header">
		<a href="http://www.cloudbees.com"><img
			src="http://di388e0fcqllf.cloudfront.net/images/cloudbees_logo.png"
			width="133" height="60" alt="CloudBees" /></a>
	</div>
	...
	<div id="cb-app-container">
		<div id="wrapper" class="clearfix">
			...
			<div id="main-content">
				...
				<p>Your new application is created and now running successfully
					in the CloudBees PaaS (this is it!). Well done!</p>
							...
							<td>
								...
								<ul class="index-list">
									<li class="left box light-box">
										<div class="hudson">
											<h4>
												<a href="https://run.cloudbees.com/">Update your
													application</a>
											</h4>
											The console development page will have instructions on how
											you can update your application. Hint: You can download and
											build off this starter app from the console if you like.
											<p />

											<p>
												<a href="https://run.cloudbees.com/"
													class="call-action
	    text-l">» Take me to the
													Console</a>
											</p>
										...
										<div class="account">
											<div class="form-p">
												<a
													href="https://cloudbees.zendesk.com/categories/2200-run-cloud">»
													Support</a>
							...
							<td>
								...
								<ul id="index-list">
									<div class="left box color-box">
										...
										<li><a href="https://cloudbees.zendesk.com/tickets/new">Report
										...
										<li><a href="http://blog.cloudbees.com">CloudBees
												blog</a></li>
										...
										<p>
											<a style="float: right" href="https://cloudbees.zendesk.com">More...</a>
										</p>
	...
	<div id="cb-footer" class="cb-hf clearfix">
		<ul id="footer-nav" class="clearfix">
			<li><a href="http://www.cloudbees.com/company-contactus.cb">Contact
					Us</a></li>
			<li><a href="http://www.cloudbees.com/status.cb">Status</a></li>
			<li><a href="http://www.cloudbees.com/security.cb">Security</a></li>
			<li><a href="http://www.cloudbees.com/company-privacy.cb">Privacy
					Policy</a></li>
			<li><a href="http://www.cloudbees.com/company-TOS.cb">Terms
					of Service</a></li>
		</ul>
		<span id="powered-by" class="right"> Application template by <a
			href="http://www.cloudbees.com/" title="Go to CloudBees.com">CloudBees</a>
		</span> <span id="copyright" class="clear block text-xxs">This
			template (only): © 2010 Cloud Bees, Inc.</span>
	</div>
